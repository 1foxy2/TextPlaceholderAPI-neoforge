        ...
        Placeholders.register(new ResourceLocation("server", "objective_name_top"), (ctx, arg) -> {
            ...
            if (args.length >= 2) {
                ...
                try {
                    ...
                    Collection<Score> scoreboardEntries = scoreboard.getPlayerScores(scoreboardObjective);
                    Score scoreboardEntry = scoreboardEntries.toArray(Score[]::new)[scoreboardEntries.size() - position];
                    return PlaceholderResult.value(scoreboardEntry.getOwner());
                } catch (Exception e) {
